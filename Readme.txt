...
mysimulator 30 3 Process1.txt Process2.txt Process3.txt Process4.txt
...
NOTE: No frame replacement was necessary in this simple example. Therefore, no difference in the output for LRU and clock.